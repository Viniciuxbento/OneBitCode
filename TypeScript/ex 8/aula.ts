interface GithubUserResponse { // criando interface para filtrar os elementos que vão ser puchados da API
    login: string
    id: number
    node_id: string
    avatar_url: string
...
interface GithubRepoResponse {
    ...
    site_admin: boolean // como o de cima ja havia as propriedades que seriam usadas aqui, foi criado o OMit para pegar todos os dados MENOS os que foram emitidos
